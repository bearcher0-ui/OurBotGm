...
class GMGN:
    ...
    def newToken(self, siteChoice):
        if siteChoice == "Pump.Fun":
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/pump/1h?limit=100&orderby=created_timestamp&direction=desc&new_creation=true"
        else:
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/moonshot/1h?limit=100&orderby=created_timestamp&direction=desc&new_creation=true"
        return url
    
    def completingToken(self, siteChoice):
        if siteChoice == "Pump.Fun":
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/pump/1h?limit=100&orderby=progress&direction=desc&pump=true"
        else:
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/moonshot/1h?limit=100&orderby=progress&direction=desc&moonshot=true"
        return url
    
    def soaringToken(self, siteChoice):
        if siteChoice == "Pump.Fun":
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/pump/1h?limit=100&orderby=market_cap_5m&direction=desc&soaring=true"
        else:
            url = "http://172.86.110.62:1337/defi/quotation/v1/rank/sol/moonshot/1h?limit=100&orderby=market_cap_5m&direction=desc&soaring=true"
        return url

    def bondedToken(self, siteChoice):
        if siteChoice == "Pump.Fun":
            url = "http://172.86.110.62:1337/defi/quotation/v1/pairs/sol/new_pairs/1h?limit=100&orderby=market_cap&direction=desc&launchpad=pump&period=1h&filters[]=not_honeypot&filters[]=pump"
        else:
            url = "http://172.86.110.62:1337/defi/quotation/v1/pairs/sol/new_pairs/1h?limit=100&orderby=open_timestamp&direction=desc&launchpad=moonshot&period=1h&filters[]=not_honeypot&filters[]=moonshot"
        return url
